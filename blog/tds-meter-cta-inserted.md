---
layout: base.njk
title: Fertilizer Guide — When, What, and How Much to Feed Your Houseplants
description: The no-nonsense guide to NPK ratios, feeding schedules, and not killing your plants with kindness.
---
...
<p style="margin:0 0 16px 0;color:#a7a7a7">Because plants can't order takeout. Eventually they need you to replenish the buffet.</p>
...
Before we get to application rates, here's something most guides skip: **your water quality affects everything.**

Tap water contains dissolved minerals and salts that build up in soil over time. This is why you sometimes see white crust on soil — it's mineral buildup from watering.

**The problem:** High mineral content (measured in PPM - parts per million) can:
- Block nutrient uptake
- Cause leaf burn similar to overfertilizing
- Create salt buildup that damages roots

**The solution:** Use a TDS meter to measure your water quality.
...
<div class="affiliate-cta affiliate-cta--primary">
  <div class="affiliate-cta__content">
    ...
    <div class="affiliate-cta__details">
      <span class="affiliate-cta__product">HM Digital TDS Meter</span>
      <span class="affiliate-cta__price">$15-25</span>
    </div>
  </div>
  <a href="https://www.amazon.com/dp/B01HYX5V3W?tag=feralfoliage-20" class="affiliate-cta__button" target="_blank" rel="noopener noreferrer sponsored">
    View on Amazon
  </a>
...
**What to aim for:**
- **Under 100 ppm** — ideal for most houseplants
- **100-200 ppm** — acceptable, but flush soil occasionally
- **Over 200 ppm** — consider filtering your water or using distilled/RO water

**Quick tip:** If your tap water is over 200 ppm, switching to filtered or distilled water for your sensitive plants (calatheas, alocasias) can make a huge difference.
...
6. **Check your water quality with a TDS meter — under 100 ppm is the sweet spot.**
