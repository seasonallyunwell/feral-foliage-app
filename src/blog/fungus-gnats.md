...
- Mosquito Bits (BTI) kill larvae in soil
- Life cycle is 3-4 weeks—you're fighting multiple generations at once
- Prevention is way easier than eradication
</div>
...
This means:
- Adults you see today laid eggs ~2 weeks ago
- Those eggs will hatch into more adults in ~3 weeks
- You need to break this cycle at multiple points
...
- **Tiny black flies** (1-8 inch) near soil surface
- They **hover when you water** (disturbed by movement)
- **White translucent larvae** visible in top inch of soil
- Plants may look **slightly stressed** (from root damage)
- **No webbing** (that's spider mites)
- **No white cottony masses** (that's mealybugs)
- **No bumps on stems** (that's scale)

<div class="callout tip">
<strong>Quick test:</strong> Place a yellow sticky trap directly on the soil surface. If you catch tiny black flies, you've got fungus gnats. If you catch nothing but still see flies, check if they're fruit flies (they're attracted to different things and need different treatment).
</div>
...
- **Let soil dry completely** 1-2 inches deep before watering again
- **Check with your finger**—not a schedule
- **Bottom watering** for affected plants (helps avoid wet top soil)
- **Remove decorative pot liners** that trap water
...
- **Horizontally on soil surface** (crawlers get stuck too)
- **Vertually stuck to pot edges** (flying ones)
- **One per affected plant** minimum
...
- Water with BTI tea every 3 days for 2 weeks
- Then weekly for maintenance
- Combine with bottom watering (see below)
...
<a href="https://www.amazon.com/dp/B000BX1KI?tag=feralfoliage-20" class="product-link" target="_blank" rel="nofollow noopener">Bonide Systemic Houseplant Insect Control →</a>
...
- **Only for ornamental plants** (not edibles or herbs you're going to eat)
- **Avoid if you have curious pets** that might chew leaves
- **Use sparingly**—this is heavy-duty
- **Follow package directions exactly**

<div class="callout warning">
<strong>Warning:</strong> Neem oil is often recommended for gnats but it's mostly preventative. It doesn't work well against larvae in soil. Save your neem for spider mites and other surface pests.
</div>
...
- **Water less in winter** (plants need less, soil stays wet longer)
- **Use pots with drainage holes** (non-negotiable)
- **Empty saucers after watering** (no standing water)
- **Let water drain completely** before putting back in decorative pots

### Quarantine New Plants

New plants can bring hitchhikers. Keep new additions isolated for 2-3 weeks:

- Check for gnats or larvae before introducing
- Treat preventively with one BTI watering
- Keep away from your established collection
- Only add to the main group once you're sure
...
- **Add perlite or pumice** (30-50% of mix)
- **Avoid pure peat moss** (holds too much moisture)
- **Use chunky orchid bark** in aroids and tropicals
- **Consider terra cotta pots** (porous, dries faster than plastic)
