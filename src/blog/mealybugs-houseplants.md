...
# Mealybugs on Houseplants — Complete Treatment Guide

<p style="margin:0 0 16px 0;color:#a7a7a7">These white cottony nightmares are persistent, but they're not invincible.</p>
...
- White, cottony, waxy masses (that's their protective coating)
- Slow-moving soft-bodied bugs underneath the fluff
- Sticky honeydew residue on leaves (this leads to sooty mold)
- Plants that look progressively weaker, yellowing, or sticky
...
<img src="/images/mealybugs-comparison.png" alt="Before and after mealybug treatment comparison" style="width:100%;border-radius:10px;margin:16px 0">
...
### Step 2: Manual Removal (First Pass)

Before reaching for sprays, physically remove what you can:

- **Dab visible bugs** with a cotton swab dipped in 70% isopropyl alcohol. This dissolves their waxy coating and kills them on contact.
- **Scrape off egg sacs** with your fingernail or a soft toothbrush.
- **Wipe down stems and leaves** with a cloth dampened with alcohol or soapy water.

Don't bother rinsing yet — you're just removing the obvious stuff. The spray comes next.

---

### Step 3: Insecticidal Soap — The Workhorse
...
1. Spray every surface of the plant — tops of leaves, undersides, stems, leaf joints
2. Don't drench it; a fine mist that coats everything is better than a heavy soak
3. Wait, then apply again (coverage matters more than quantity)
4. **Repeat every 5-7 days for 3-4 weeks minimum**
...
<img src="/images/mealybugs-treatment.png" alt="Mealybug treatment supplies - spray bottle, cotton swabs, alcohol" style="width:100%;border-radius:10px;margin:16px 0">

<div class="callout tip">
<strong>Pro tip:</strong> Spray in the evening or when the plant isn't in direct sun. Soap + bright sun = leaf burn.
</div>

---

### Step 4: Check the Roots (If It Keeps Coming Back)
...
2. Look for white, cottony masses on the roots
3. If you see them, you've got root mealybugs

<img src="/images/mealybugs-roots.png" alt="Root mealybugs on plant roots - white cottony masses" style="width:100%;border-radius:10px;margin:16px 0">

**Treatment options for root mealybugs:**
- **Repot entirely** — shake off all soil, clean the pot with 10% bleach solution, repot in fresh soil
- **Systemic granules** — Bonide Systemic Houseplant Insect Control works into the soil and poisons the bugs from the inside. (Edibles: no. Ornamentals: yes.)
- **Soak treatment** — water with a diluted insecticidal soap solution, let it soak the root zone, repeat for 2-3 waterings

---

### Step 5: Prevention — Because Nobody Wants Round Two
...
- **Inspect regularly** — check leaf joints and new growth weekly
- **Isolate at first sign** — one white blob is an infestation waiting to happen
- **Don't over-fertilize** — nitrogen-heavy fertilizer produces soft new growth that mealybugs love
...
1. **Isolate fast** — don't let them spread
2. **Be thorough** — check leaf joints, undersides, and roots
3. **Stay consistent** — treat for 3-4 weeks minimum
4. **Don't skip the root check** — if it keeps coming back, that's why

Yes, it's annoying. But you can win this.

---

*Need help identifying what you're dealing with? Our [Pest ID Guide](/blog/pest-id/) covers mealybugs plus the other common houseplant pests. Already got your treatment supplies? Here's the minimal [Pest Control Starter Kit](/blog/pest-control-kit/) worth having on hand.*
