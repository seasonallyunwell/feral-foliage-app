---
layout: base.njk
title: Why Is My Plant Drooping? — Diagnose and Fix
description: Drooping isn't always death. Here's how to tell what's wrong and fix it.
---
...
<p style="margin:0 0 16px 0;color:#a7a7a7">Drooping is a symptom, not a diagnosis. Here's your plant's way of talking.</p>
...
- Yellowing leaves with drooping
- Soft, mushy stems
...
- Happened within 1-2 weeks of repotting
...
5. Give time — most recover in 2-3 weeks
...
**Signs:**
- Sudden drooping
- Happened near cold draft or heat vent
- Leaves may curl or drop

**Fix:**
1. Move away from drafts (windows, doors, vents)
2. Maintain stable temperature (65-80°F)
...
**Signs:**
- Crispy edges with drooping
- Happens in winter with heating on
- Ferns and calatheas especially
...
### Signs It's Too Late
- Stem is mushy from base up
- All roots are black and mushy
- No healthy tissue left
- Smell of rot from plant
...
1. **Check soil first** — dry = water, wet = let dry
2. **Check roots** — black/mushy = rot
3. **Check environment** — light, temperature, humidity
4. **Act fast** — drooping is a warning sign
