...
<p style="margin:0 0 16px 0;color:#a7a7a7">Is your plant shedding? Or is it dying? Learn the difference between natural leaf drop and an emergency, with a quick decision tree.</p>
...
<div class="callout">
<strong>TL;DR:</strong> Bottom leaves yellowing usually normal aging. Sudden green leaf drop indicates shock or overwatering. Species matters: Ficus drops when moved, succulents naturally shed lower leaves. Check root rot if rapid drop occurs.
</div>
...
Plants shed leaves for many reasons. Some are completely natural (your plant is just making room for new growth). Others are signs of serious distress (root rot, shock, pests). Here is how to tell the difference.
