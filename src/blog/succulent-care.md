---
layout: base.njk
title: Succulent Care — The No-Nonsense Guide to Not Killing Them
description: Succulents are marketed as unkillable, but they die in homes every day. Here's how to actually keep them alive.
slug: succulent-care
date: 2026-02-18
...
<p style="margin:0 0 16px 0;color:#a7a7a7">They're sold as "unkillable." They die. Here's why — and how to actually keep them alive.</p>
...
1. **Soak** — Water thoroughly until it drains from the bottom
2. **Wait** — Let the soil dry out completely (5-14 days depending on your climate)
3. **Repeat**
...
1. **Get a grow light** — LED grow lights are cheap and effective. 6-8 hours mimics natural sunlight.
2. **Accept fewer species** — some succulents (haworthia, gasteria) tolerate lower light better than others (echeveria, sedum).
...
| Material | Pros | Cons |
|----------|------|------|
| Terracotta | Breathable, dries fast | Heavy, can crack in frost |
| Ceramic (glazed) | Pretty, retains moisture | Holds water longer |
| Plastic | Light, cheap | Can hold too much moisture |
| Concrete | Modern look, heavy | Very drying |
...
**Fix:** Let soil dry completely. If rot has set in, cut off healthy parts and propagate.

### 2. Etiolation (Stretching)
**Cause:** Not enough light  
**Fix:** Move to brighter spot or add grow light. Once stretched, it won't un-stretch — but new growth will be compact.

### 3. Overwatering
**Cause:** Watering too frequently, soil holding too much moisture  
**Fix:** Let soil dry completely between waterings. Use terracotta. Use the soak-and-dry method.

### 4. Underwatering
**Cause:** Neglect, soil repelling water  
**Fix:** Water thoroughly (soak method). If soil is hydrophobic (repelling water), soak the whole pot for 15 minutes.

### 5. Pests
**Cause:** Usually brought in on other plants  
**Fix:** Isolate new plants. Common culprits: mealybugs (white cottony stuff), spider mites (webbing). Wipe with rubbing alcohol or spray with insecticidal soap.
...
1. **Choose a healthy leaf** — Gently twist off a healthy, plump leaf. Don't tear it — you need the entire base where it connects to the stem. A clean break is essential.
2. **Let it callous** — Set the leaf somewhere dry and bright (not direct sun) for 2-3 days. The cut end needs to form a callous before it'll root.
3. **Place on soil** — Lay the leaf on top of dry succulent soil. Don't bury it.
4. **Wait** — This is the hard part. Check on it every few days. It takes 2-4 weeks for roots to appear.
5. **Mist lightly** — Once you see tiny roots, mist the soil lightly when it dries. Not too much — just enough to encourage root growth.
6. **Watch for babies** — Tiny rosettes will eventually form at the base. The mother leaf will shrivel and die as the baby grows. This is normal.
...
1. **Cut the stem** — Use clean, sharp scissors to cut a stem with healthy leaves.
2. **Let it callous** — Same as leaves: 2-3 days in a dry spot.
3. **Plant it** — Stick the cut end into dry soil about 1 inch deep.
4. **Wait** — 2-3 weeks before watering. The stem needs to grow roots first.
5. **Test for roots** — Gently tug after a month. Resistance means roots have formed.
