...
# Syngonium Care Guide — Arrowhead Vines for Every Style

<p style="margin:0 0 16px 0;color:#a7a7a7">Arrowhead vines are the low-fuss aroid you'll want in every room. Here's how to keep them alive — and looking good.</p>

<img src="/images/syngonium-varieties-flatlay-hero.jpg" alt="Seven syngonium varieties arranged by aesthetic style — dark, white variegated, pink, and solid green — in an overhead flatlay against a light background" style="width:100%;border-radius:10px;margin:16px 0">
...
<div class="callout">
<strong>TL;DR:</strong> Bright indirect light (no direct sun), water when the top inch of soil is dry, chunky aroid soil, and feed monthly in spring/summer. Pick your syngonium's look: trail it, stake it, or prune it bushy.
</div>
...
## Why Syngonium Is the Best Beginner Aroid
...
## The Varieties: Syngonium by Aesthetic
...
<figure>
<img src="/images/syngonium-care-essentials-flatlay.jpg" alt="Flatlay of syngonium care essentials: a bag of aroid soil mix, liquid fertilizer bottle, moss pole, and moisture meter on a wooden surface" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>The syngonium care toolkit: chunky aroid soil, monthly liquid feed, a moss pole for climbing, and a moisture meter to take the guesswork out of watering.</figcaption>
</figure>

### Dark & Moody — The Witchy Collection

If your aesthetic skews gothic, boho-dark, or just aggressively cozy, these are your plants:

- **Syngonium 'Black Velvet'** — near-black leaves with contrasting light veins. The most dramatically dark of the bunch.
- **Syngonium 'Maria'** — deep green so dark it reads as black in low light, compact growth habit.
- **Syngonium 'Batik'** — dark green with cream and silver variegation patterns that look almost tie-dyed.

These varieties are forgiving with light — the darker the leaves, the more shade-tolerant the plant tends to be.

### Clean & Bright — The Modern Minimalist

For bright, airy spaces that need a plant that won't compete with the vibe:

- **Syngonium 'White Butterfly'** — white and pale green variegated leaves, clean and architectural.
- **Syngonium 'Albolineata'** — cream-white margins on green leaves, striking contrast.
- **Syngonium 'Neon Robusta'** — solid pinkish-bronze new growth that lightens to a soft green. Surprisingly easy.

These varieties need more light to maintain their variegation. Put them near a window, but not in direct sun.

### Warm & Textured — The Boho Tropical

For warm-toned spaces, terracotta pots, and layered textures:

- **Syngonium 'Pink Allusion'** — soft pink veins on a pale green leaf, the classic "pink syngonium."
- **Syngonium 'Neon Pink'** — vibrant neon pink that pops against dark foliage. More light = more pink.
- **Syngonium 'Berry Allusion'** — dusky pink and green with a muted, earthy quality.

Pink variegation is light-dependent. More bright indirect light = more pink. In low light, these tend to fade to green.

### All Green, All Classic — The Trusty Standby

Don't underestimate the solid green syngonium. These are the hardest to kill and the fastest growers:

- **Syngonium 'Emerald Gem'** — deep green, arrow-shaped leaves, bulletproof.
- **Syngonium 'Green Gold'** — gold-green variegation that reads as mostly green from a distance.
...
**Pro tip:** A [moisture meter](/blog/starter-kit/) takes the guesswork out of this entirely. Under $15 and it removes all ambiguity.
...
<a href="https://www.amazon.com/dp/B00CY4GCS4" class="product-link">See on Amazon — FoxFarm Ocean Forest</a>
...
If you prefer a pre-made chunky mix, <a href="https://www.amazon.com/dp/B00PM1500G" class="product-link">Better-Gro Phalaenopsis Orchid Mix</a> is a solid option — it's got the bark, perlite, and charcoal balance that works well for syngonium.
...
If you live in a dry climate — or run heat in the winter — a humidifier helps. The <a href="https://www.amazon.com/dp/B09QH9C4JZ" class="product-link">Levoit Classic 300S</a> is a solid pick for a small room. Quiet, reliable, and covered under Feral Foliage's affiliate.
...
<a href="https://www.amazon.com/dp/B00WFQFYIU" class="product-link">See on Amazon — FoxFarm Tiger Bloom</a>
...
## The Vining vs. Bushy Question: Choosing Your Plant's Look

This is the decision that trips up a lot of syngonium owners, so let's be clear about what you actually want.

<figure>
<img src="/images/syngonium-hanging-vs-staked-comparison.jpg" alt="Two syngonium plants shown in different display styles — left plant trails from a hanging basket, right plant climbs up a moss pole" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>Two looks, one plant: let your syngonium trail from a hanging basket (left) or guide it up a moss pole for large, mature foliage (right).</figcaption>
</figure>
...
<figure>
<img src="/images/syngonium-juvenile-vs-adult-leaves.jpg" alt="Closeup of two syngonium leaves from the same plant — left leaf is small, arrowhead-shaped (juvenile) and right leaf is larger with deep lobes (adult)" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>Same plant, two eras: the arrowhead-shaped juvenile leaf on the left vs. the deeply lobed adult leaf on the right. This is normal — it means your syngonium is thriving.</figcaption>
</figure>

To get the big mature leaves with deep lobes, give your syngonium something to climb. An extendable moss pole (like <a href="https://www.amazon.com/dp/B0BJCW1K92" class="product-link">this Highland Moss pole on Amazon</a>) works well — just mist it and watch the aerial roots grab on.
...
If your syngonium has gotten leggy — long stems with sparse leaves — you can fix it. <a href="/blog/how-to-prune/">How to prune leggy plants</a> is a skill, but the basic move is:
...
<figure>
<img src="/images/syngonium-pruning-before-after.jpg" alt="Side-by-side comparison of a leggy, stretched syngonium before pruning and the same plant six weeks later, full and bushy" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>The same syngonium before and after a pruning session — six weeks of regrowth makes all the difference.</figcaption>
</figure>
...
## Why Did My Syngonium Change Leaf Shape?
...
- **Juvenile leaves:** Arrowhead-shaped (hence the common name). This is what the plant looks like when young.
- **Adult leaves:** Often deeply lobed, larger, sometimes almost fenestrated like a small monstera.
...
## Syngonium Problems and How to Fix Them
...
1. **Underwatering** — the soil is dry and the plant is thirsty. Solution: water it.
2. **Root rot** — the roots are damaged and can't absorb water even though the soil is wet. Solution: unpot, trim any black/mushy roots, repot in fresh dry mix, water lightly.
...
Syngonium is occasionally targeted by **spider mites and mealybugs** — check out <a href="/blog/pest-id/">FF's pest identification guide</a> for help telling them apart.
...
<figure>
<img src="/images/syngonium-propagation-water-roots.jpg" alt="Clear glass jar with a syngonium stem cutting in water, showing white roots growing from the node, on a sunny windowsill" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>Syngonium propagation in water — take a cutting below a node, wait 2-4 weeks for roots, then pot up. The node is where the magic starts.</figcaption>
</figure>

**What you need:**
- A stem cutting with at least one node (the bumpy part where a leaf or aerial root attaches — this is non-negotiable, nodes are where roots grow from)
- A clear glass jar
- Room-temperature water

**Steps:**
1. Cut below a node — the node should be the lowest point on your cutting, submerged in water
2. Remove any leaves that would sit below the waterline (they'll rot)
3. Place in a clear jar of water on a bright windowsill (no direct sun)
4. Change the water every few days to keep it fresh
5. Wait 2-4 weeks for roots to appear (1-2 inches is a good target before potting)
6. Pot in aroid mix when roots are about 2 inches long

**FAQ:** Can you propagate syngonium in soil? Yes — the same stem cutting can go directly into moist aroid mix. Success rate is slightly lower for beginners since you can't see the roots. For more on propagation in general, see <a href="/blog/propagation/">FF's houseplant propagation guide</a>.

---

## Toxicity: Keep Syngonium Away from Pets
...
If you have curious pets who chew on plants, keep syngonium on a high shelf or in a room they can't access. For pet-safe alternatives, see <a href="/blog/pet-safe-plants/">FF's guide to pet-safe houseplants</a>.

---

## Syngonium Quick-Care Cheat Sheet

- **Light:** Bright indirect — tolerates lower light better than most aroids
- **Water:** When top 1-2 inches of soil are dry; yellow leaves = overwatering
- **Soil:** Chunky aroid mix with perlite and bark for drainage
- **Humidity:** Prefers 60%+ but survives average household humidity
- **Temperature:** 65-85°F — keep away from cold drafts
- **Fertilizer:** Monthly liquid feed spring/summer, none in fall/winter
- **Growth:** Fast — juvenile arrowhead leaves or adult lobed leaves depending on climbing
...
- <a href="https://www.amazon.com/dp/B00CY4GCS4" class="product-link">FoxFarm Ocean Forest Potting Soil</a> — our go-to aroid base
- <a href="https://www.amazon.com/dp/B00PM1500G" class="product-link">Better-Gro Orchid Mix</a> — chunky bark alternative for syngonium soil
- <a href="https://www.amazon.com/dp/B00WFQFYIU" class="product-link">FoxFarm Tiger Bloom</a> — the liquid fertilizer we reach for most
- <a href="https://www.amazon.com/dp/B0BJCW1K92" class="product-link">Highland Moss Extendable Pole</a> — for climbing syngonium
- <a href="https://www.amazon.com/dp/B09QH9C4JZ" class="product-link">Levoit Classic 300S Humidifier</a> — for dry rooms and winter months

---

*Ready to add more beginner-friendly aroids to your collection? Start with [FF's easiest houseplants guide](/blog/easiest-houseplants/) — same no-nonsense approach, zero gatekeeping.*
