...
<p style="margin:0 0 16px 0;color:#a7a7a7">Everything you need to keep your philodendron thriving — from watering disasters to humidity hacks.</p>

<img src="/images/philodendron-hero-heartleaf-hanging.jpg" alt="Lush heartleaf philodendron trailing from a hanging macrame basket with healthy, glossy green heart-shaped leaves" style="width:100%;border-radius:10px;margin:16px 0">
...
<div class="callout">
<strong>TL;DR:</strong> Philodendrons want bright indirect light, water when the top inch is dry, and 50%+ humidity. Yellow leaves usually mean overwatering. Brown tips mean humidity is too low. They're forgiving — don't stress too hard.
</div>
...
- **Heartleaf** (Philodendron hederaceum) — The classic. Heart-shaped leaves, almost impossible to kill.
- **Brasil** — Variegated green and lime. Looks fancy, is equally tolerant.
- **Lemon Lime** — Bright chartreuse. Gives you confidence even when you're failing.
- **Micans** — Velvety leaves with bronze undertones. A little extra, but worth it.
...
- **Selloum** — Big, dramatic, deeply lobed leaves. Gets huge.
- **Xanadu** — More compact, denser growth. The polite version of Selloum.
- **Birkin** — White variegation that looks hand-painted. A bit dramatic about everything but stunning.
...
<figcaption>From left: Heartleaf, Brasil, Birkin, and Selloum — same genus, wildly different personalities</figcaption>
</figure>
...
- South or west: pull it back a few feet, or filter with a sheer curtain.
- North-facing: might work for heartleaf (most tolerant), but expect slower growth.

Signs your light is wrong:
- **Too much:** Brown scorched patches, faded bleached-looking leaves
- **Too little:** Leggy growth, small new leaves, variegation fading (on variegated varieties)
...
<figure style="margin:24px 0">
<img src="/images/philodendron-drooping-vs-healthy-comparison.jpg" alt="Side-by-side comparison of a thirsty drooping philodendron and a properly watered healthy perky philodendron" style="width:100%;border-radius:10px">
<figcaption>Left: needs water ASAP. Right: happily hydrated. Learn to read the signs.</figcaption>
</figure>
...
- **Below 40%:** Brown tips appear. Plant survives but looks rough.
- **50-60%:** Happy place. Leaves get that glossy, lush look.
- **Above 70%:** Even better, but watch for fungal issues if airflow is poor.
...
<figure style="margin:24px 0">
<img src="/images/philodendron-brown-tips-humidity-closeup.jpg" alt="Close-up macro shot of philodendron leaf with brown crispy tips, humidifier visible in background" style="width:100%;border-radius:10px">
...
- **Orchid bark** (30-40%) — Adds drainage and air to the roots
- **Perlite** (20-30%) — Extra drainage insurance
- **Coco coir or peat** (20-30%) — Holds some moisture without getting soggy
- **Worm castings** (10%) — Optional, but adds nutrients
...
- It's been 12-18 months since last repotting
...
- Brown leaf tips (can look like humidity damage)
...
- **Overwatering (most common):** Yellow leaves that feel soft or mushy, often starting from the bottom. Soil stays wet too long. Solution: water less, check drainage, maybe repot into fresh dry soil if root rot has set in.
- **Underwatering:** Yellow leaves that feel crispy or dry, often accompanied by drooping. Soil pulls away from the pot edges. Solution: water thoroughly.
...
- **Thirsty:** Soil is dry, leaves droop, plant perks up within hours of watering.
- **Root rot:** Soil is wet, leaves droop, plant does NOT perk up after watering. You might also smell rot or see mushy black roots.
...
- **Mealybugs** — White cottony fluff in leaf joints. Dab with rubbing alcohol on a q-tip.
- **Spider mites** — Tiny pests that leave fine webbing. Increase humidity (they hate moisture), wipe leaves down, spray with insecticidal soap.
...
<figure style="margin:24px 0">
<img src="/images/philodendron-propagation-water-cuttings.jpg" alt="Philodendron stem cuttings in clear glass jar of water showing root development with visible nodes" style="width:100%;border-radius:10px">
<figcaption>Rooting in progress — see those little white roots emerging? That's success.</figcaption>
</figure>
...
<figure style="margin:24px 0">
<img src="/images/philodendron-care-cheat-sheet-summary.jpg" alt="Visual quick reference cheat sheet showing philodendron care requirements for light, water, humidity, and soil" style="width:100%;border-radius:10px">
<figcaption>Pin this for later — quick reference for happy philodendrons</figcaption>
</figure>
...
*Want to dive deeper? Check out our [watering guide](/blog/watering-guide/) for the full methodology, or browse our [propagation guide](/blog/propagation/) to turn one philodendron into ten.*
