---
layout: base.njk
title: Common Houseplant Myths That Need to Die
description: Your plants aren't trying to kill you. Here are the lies the internet told you.
---

<div class="card">

# Common Houseplant Myths That Need to Die

<p style="margin:0 0 16px 0;color:#a7a7a7">The internet has lied to you. Your plants are fine. Here's what's actually true.</p>
...
- ZZ plant (survives, doesn't thrive)
- Snake plant (same)
- Chinese evergreen (same)

**The Fix:** Get a grow light. $20 solves most "no window" problems.

---

## Myth 2: Watering on a Schedule Is Good
...
## Myth 3: More Fertilizer = More Growth
...
## Myth 4: Drainage Rocks Prevent Root Rot
...
## Myth 5: Misting Increases Humidity
...
- Humidifier (best)
- Pebble tray (okay, limited effect)
...
## Myth 7: All Plants Need Sunlight
...
## Myth 8: Yellow Leaves Mean Water More
...
**The Diagnosis:**
- Yellow lower/older leaves + wet soil = overwatering
- Yellow new leaves + dry soil = underwatering
- Yellow leaves everywhere + wet soil = root rot

**The Fix:** Check soil before watering. Don't assume.

---

## Myth 9: Tap Water Will Kill Your Plants
...
**The Truth:**
- Let tap water sit 24 hours (chlorine evaporates)
- Most plants don't care
- Sensitive plants need filtered water

**The Fix:** Don't overthink water. If your plants are thriving, keep doing what you're doing.

---

## Myth 10: Succulents Don't Need Water
...
## Myth 11: Repotting Is Always Good
...
## Myth 12: Humidity Trays Actually Work
...
**What Actually Helps:**
- Humidifier (real effect)
- Bathroom showers (temporary)
- Grouping plants (some effect)

**The Fix:** If you need humidity, buy a humidifier. Pebble trays are decorative at best.

---

## Myth 13: North-Facing Windows Have No Light
...
## Myth 14: You Can't Overwater in Winter
...
- Soil dries slower
- Dormant plants can't process water

**The Fix:** Water LESS in winter, not the same amount. Check soil before watering.

---

## Myth 15: Plant Stores Know What They're Talking About
...
- "Low light" ≠ no light
- Check soil, not calendars
- Less fertilizer is better
- Don't put rocks in pots
- Misting does nothing
- Plants aren't air purifiers
- Yellow leaves ≠ water more
- Tap water is fine for most
- Succulents still need water
- Don't repot unnecessarily
- North windows are good
