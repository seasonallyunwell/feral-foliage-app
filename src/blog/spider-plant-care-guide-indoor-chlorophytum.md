...
# Spider Plant Complete Care — The Ultimate Guide to Chlorophytum

<p style="margin:0 0 16px 0;color:#a7a7a7">The starter plant that never stops giving — and how to keep it alive without trying too hard.</p>

<img src="/images/spider-plant-hero-cascade.jpg" alt="Mature spider plant in a hanging macramé planter with spiderettes trailing over the sides in a sunny room" style="width:100%;border-radius:10px;margin:16px 0">
...
<div class="callout">
<strong>TL;DR:</strong> Bright indirect light (no direct sun). Water when the top 1-2 inches of soil are dry — about once a week in warm months. Well-draining potting mix in a snug pot. Spider plants are forgiving, pet-safe, and will produce babies you can turn into an entire collection.
</div>

---

## About Spider Plants: Meet Chlorophytum Comosum
...
Here's the thing the internet doesn't lead with: **spider plants are non-toxic to cats and dogs.** The ASPCA has them listed as safe, which makes them one of the few stylish houseplants you can keep without worrying about your pets. If you want more options, here's our [pet-safe houseplants list](/blog/pet-safe-plants/).
...
## Light Requirements: The One Condition That Matters Most
...
White or brown scorched patches on the leaves. The solid green varieties are slightly more tolerant of direct sun than their variegated siblings, but nobody wins when you put a spider plant in hot afternoon sun.

**Best placement:**
- East-facing windowsill (gentle morning sun)
- West-facing windowsill with some afternoon shade
- A few feet back from a south-facing window with filtered light
- North-facing windows work for solid green varieties, though growth will slow
...
**Fix:** Fill a watering can and let it sit out for 24 hours before using. This lets the chlorine dissipate. Better yet, use filtered or distilled water. A <a href="https://www.amazon.com/dp/B00LZCDPP0" class="product-link" target="_blank" rel="noopener">Brita water filter pitcher</a> is a cheap investment if you're serious about keeping your spider plant looking pristine.
...
For the deep dive on watering technique, see our [general watering principles](/blog/watering-guide/) and our guide to [treating root rot](/blog/treat-root-rot/) if you've already overdone it.

---

## Soil and Repotting: Don't Overpot
...
<a href="https://www.amazon.com/dp/B00KQHN45W" class="product-link" target="_blank" rel="noopener">Espoma Organic Perlite</a> at 30-40% ratio lightens up any potting mix and keeps things draining properly. It is genuinely the single most useful amendment you can add to almost any houseplant's soil.
...
**The snug pot principle:** Spider plants like being slightly root-bound. Don't jump up more than 1-2 inches in pot diameter when repotting. A too-large pot holds more soil, which holds more water, which means root rot risk. See our [best pots for houseplants](/blog/best-pots/) guide for more on this.

<figure>
<img src="/images/spider-plant-rootbound-signs.jpg" alt="Spider plant with cracked terracotta pot and roots growing above the soil surface showing it's severely root-bound" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>Cracked pot + roots above soil = root-bound. Spider plants have massive tuberous root systems — they need repotting more often than most plants.</figcaption>
</figure>

**How to know when to repot:**
- Roots growing out of the drainage holes
- White roots visible above the soil line
- The pot feels unusually tight or the plant pops up when you water
- Cracked or deformed pot (yes, spider plant roots are that powerful)
...
**When to feed:**
- Spring through summer: every 4-6 weeks
- Fall and winter: skip it entirely
...
## Spider Plant Varieties: A Quick Comparison

Most people don't realize there are several distinct spider plant varieties, and they have different care needs:

<figure>
<img src="/images/spider-plant-varieties-comparison.jpg" alt="Four spider plant varieties side by side: solid green, variegated vittatum, reverse variegated, and Bonnie curly" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>Clockwise from top-left: solid green, variegated (vittatum), reverse variegated, and Bonnie (curly) — each with distinct care needs.</figcaption>
</figure>
...
<figure>
<img src="/images/spider-plant-propagation-steps.jpg" alt="Three-step spider plant propagation sequence showing spiderette with root nubs, water rooting, and transplanted baby" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>Three stages of spider plant propagation: identifying a ready spiderette (left), rooting in water (center), and the transplant with new growth (right).</figcaption>
</figure>

### The readiness checklist (don't skip this)
...
- 5 or more leaves
- Visible white root bumps (root nubs) where it attaches to the stolon
...
1. Cut the spiderette from the mother plant with 1-2 inches of stolon attached
2. Place in a jar of room-temperature water, covering just the root nubs
3. Change the water every 3-4 days
4. Wait 2-4 weeks for roots to grow to 1-2 inches
5. Pot in well-draining soil

### Method 2: Soil rooting (while attached)

1. Fill a small pot with well-draining soil and place it next to the mother plant
2. Pin or weigh the spiderette onto the soil surface so the root nubs make contact
3. Keep the soil lightly moist
4. Once roots are established (gentle tug meets resistance), cut the stolon connecting it to the mother

### Method 3: Division at repotting

1. Unpot the mother plant and shake off excess soil
2. Gently separate the root ball into sections, each with its own leaves and roots
3. Pot each division separately
...
For more on propagation generally, see our [general propagation principles](/blog/propagation/) — spider plant is one of the best subjects for beginners to start with.

---

## Troubleshooting: What's Wrong With My Spider Plant?

<figure>
<img src="/images/spider-plant-brown-tip-patterns.jpg" alt="Close-up of spider plant leaves showing brown tip necrosis from fluoride sensitivity vs whole leaf yellowing from overwatering" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>Brown tips vs. yellowing — two very different problems. Fluoride causes tip burn; overwatering turns whole leaves yellow from the base up.</figcaption>
</figure>
...
<a href="https://www.amazon.com/dp/B00LZCDPP0" class="product-link" target="_blank" rel="noopener">Solve Brown Tips — Get a Filtered Water Pitcher</a>

### Yellow leaves
**Most likely cause: overwatering.** Spider plants turn yellow from the base of the leaf upward when they're waterlogged. Let the soil dry out more between waterings. If it's severe, check for root rot (see our guide to [treating root rot](/blog/treat-root-rot/)).
...
### Pale, washed-out leaves / loss of variegation
...
### No spiderettes / no babies
Three reasons your spider plant isn't producing babies:
1. **Too young** — young plants put energy into root and leaf growth before reproducing
2. **Not enough light** — spider plants produce more spiderettes in brighter conditions
3. **Too root-bound** — a cramped root system triggers reproduction as a survival mechanism. Try sizing up the pot slightly.

For more symptom patterns, [browse the Plant ER for more diagnosis help](/blog/plant-er/).

---

## Pests: Spider Plants Are Resistant But Not Immune

Spider plants are **low-pest targets** — they're not immune, but they're not pest magnets either. The usual suspects:

- **Mealybugs** — white cottony clusters at the leaf base. Most common on spider plants.
- **Spider mites** — tiny dots on leaf undersides, fine webbing between leaves
- **Scale** — brown or tan bumps on stems and leaf surfaces
- **Aphids** — less common, usually on new growth
...
## Where to Buy Spider Plants and What to Look For
...
<figure>
<img src="/images/spider-plant-macrame-hanger-lifestyle.jpg" alt="Spider plant in a ceramic pot hanging from a natural cotton macramé hanger beside a bright window with sheer curtains" style="width:100%;border-radius:10px;margin:16px 0">
<figcaption>The classic spider plant setup: a snug pot, a simple macramé hanger, and a bright window with filtered light.</figcaption>
</figure>

For the hanging display, a simple macramé hanger works perfectly — the spiderettes cascade down naturally and it shows off the plant the way it's meant to be seen. A <a href="https://www.amazon.com/dp/B08XYZ1234" class="product-link" target="_blank" rel="noopener">set of macramé hangers</a> is a solid purchase if you're planning to add a few trailing plants to your collection.
...
*Want plants that are even harder to kill? See our [easiest houseplants guide](/blog/easiest-houseplants/).*
...
- <a href="https://www.amazon.com/dp/B00LZCDPP0" target="_blank" rel="noopener">Brita Water Filter Pitcher (White)</a> — solves the fluoride brown tip problem
- <a href="https://www.amazon.com/dp/B00KQHN45W" target="_blank" rel="noopener">Espoma Organic Perlite — 8 Quart</a> — the amendment that fixes most soil drainage problems
- <a href="https://www.amazon.com/dp/B08XYZ1234" target="_blank" rel="noopener">XL Macramé Plant Hanger (set of 3)</a> — the classic spider plant display setup
- <a href="https://www.amazon.com/dp/B00H4LNOK8" target="_blank" rel="noopener">General Hydroponics Liquid Nutrient Trio (FloraSeries)</a> — if you do fertilize, this is a solid balanced option
